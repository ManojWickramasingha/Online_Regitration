    ...
    <div class="container-xxl bg-white p-0">
                ...
                <div class="navbar-nav mx-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                            ...
                            <a href="call-to-action.php" class="dropdown-item active">Become A Student</a>
        ...
        <div class="container-xxl py-5 page-header position-relative mb-5">
            <div class="container py-5">
                <h1 class="display-2 text-white animated slideInDown mb-4">Become A Student</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Become A Student</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                ...
                                <p class="mb-4">Becoming a student at our campus is highly important as it offers access to quality education, resources, and opportunities for personal and professional growth. Our institution provides a supportive learning environment, diverse community, and various extracurricular activities to enhance the overall student experience. By enrolling as a student, individuals can expand their knowledge, skills, and network, ultimately preparing them for future success in their chosen field.
                                </p>
